<div class="border-bottom d-flex justify-content-between py-3">
    ...
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">
        <i class="bi bi-plus"></i> Tamabah Kategori</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="status">
                                <option value="" selected disable>Pilih Status</label>
        ...
        <tbody>
            ...
            while($row_kategori = $result_kategori->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td><span class="badge <?= $row_kategori['status'] == 1?'text-bg-success':'text-bg-danger';?>"><?=$row_kategori['status']
                    == 1?'Aktif':'Tidak Aktif'; ?></span></td>
                    <td>
                        <a href="" data-bs-togglr="modal" data-bs-target="#modalEdit<?=$row_kategori['id_kategori'];?>" class="text-info"><i class="bi bi-pencil-squere"></i>
            </a>
                        <div class="mode fade" id="modalEdit<?=$row_kategori['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="modul/kategori/proses.php?aksi=edit&id=<?=$row_kategori['id_kategori'];?>" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="statu">Status</label>
                                                <select class="form-select" name="status">
                                                    <option value="" selected disable>Pilih Stus</option>
                                ...
                                <di class="modal fade" id="modalHapus<?= $row_kategori['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLbel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLbel">Hapus Data kategori</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
