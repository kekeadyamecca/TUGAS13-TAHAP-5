<div class="border-bottom d-flex justify-content-between py-3">
    ...
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="bi i-plus"></i> Tambah Persediaan</button>
    <!-- Modal -->
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="deskripsi">Deskripsi</label>
                                            <input type="number" name="deskripsi" class="form-control"placeholder="Contoh : Penambahan barang" />
                                        </div>
                                    </div> 
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
