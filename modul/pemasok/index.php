<div class="border-bottom d-flex justify-content-between py-3">
    ...
    class="bi bi-plus"></i> Tambah Pemasok</button>
    <!-- Modal -->
            ...
            <div class="modal-content">
                ...
                <form action="modul/pemasok/proses.php?aksi=tambah" method="post">
                    ...
                    <select class="form-select" name="status">
                        <option value="" select disabled>Pilih Status</option>
...
<table id="myTable">
  ...
  <?php
    ...
    <tr>
        ...
        <td><span class="badge <?= $row_pemasok['status']== 1?'text-bg-success':'text-bg-dangger';?>"><?= $row_pemasok['status']
        ...
        <td>
          <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?=$row_pemasok['id_pemasok'];?>" class="text-info">
            ...
            <div class="modal fade" id="modalEdit<?= $row_pemasok['id_pemasok'];?>"tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="modul/pemasok/proses.php?aksi=edit&id=<?=$row_pemasok['id_pemasok'];?>"method="post">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label" for="namapemasok">Nama Pemasok</label>
                                <input class="form-control" type="text" name="namapemasok"placeholder="Masukkan nama pemasok" value="<?=
                                $row_pemasok['nama_pemasok'];?>"required>
                            </div>
                        <div class="mb-3">
                            <label class="form-label" for="alamat">Alamat</label>
                            <input class="form-control" type="text" name="alamat"placeholder="Masukkan alamat " value="<?=
                                $row_pemasok['alamat'];?>"required>
                            </div>
                        <div class="mb-3">    
                            <label class="form-label" for="telepon">Telepon</label>
                            <input class="form-control" type="text" name="telepon"placeholder="Masukkan telepon " value="<?=
                                $row_pemasok['telepon'];?>"required>
                            </div>
                        <div class="mb-3">  
                            <label class="form-label" for="status">Status</label> 
                            <select class="form-select" name="status">
